...
<div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    ...
                    <form enctype="multipart/form-data" action="{{ url('dashboard/all-users/store') }}" method="POST">
                            @csrf
                            
                            <h4>Name: <input type="text" class="control-label mb-1" name="name"></h4>
                            <h4>Email: <input type="text" class="control-label mb-1" name="email" ></h4>

                            <h4>Select Type:  
                            <select name="type" class="form-control selectpicker mt-2" >
                                    <option value="Student" >Student</option>
                                    <option values="Teacher">Teacher</option>
                                    <option values="Admin">Admin</option>
                            </select>
                            </h4>
                            <h4>Password: <input type="text"  class="control-label mb-1"  name="password" ></h4>
                           
                            <hr>
                            <input type="submit" value="Add User" class="mt-1 form-control-file btn btn-sm btn-primary" id="user_update">
