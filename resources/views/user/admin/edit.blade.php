            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    ...
                    <form enctype="multipart/form-data" action="{{ url('dashboard/applications/approve/'.$edituser->id.'/store') }}" method="POST">
                            ...
                            <h4>Password: <input type="text"  class="control-label mb-1"  name="password" value=""></h4>
                           
                            <hr>
                            <input type="submit" value="Update User" class="mt-1 form-control-file btn btn-sm btn-primary" id="user_update">
